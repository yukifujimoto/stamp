...
　　　　Parameters
    ...
    　　black_cell_coordinate_list : list of tuple
        ...
        print(cls.black_cell_list_of_target_field)
    ...
    def divide_field(cls, division_unit_x_axis, division_unit_y_axis):
        ...
        # リスト内包表記を用いて、2次元配列を作る　※2次元配列の各要素を異なるID（識別子）で作成可能
        #cls.divide_list = [[0 for j in range(division_unit_x_axis)] for i in range(division_unit_y_axis)]

        #  フィールドを分割する
        temp_start_point_x = 0
        temp_start_point_y = 0
        for start_point_y in division_start_point_y_list:
            for start_point_x in division_start_point_x_list:
                ...
                for current_point_y in range(temp_start_point_y, start_point_y):
                    for current_point_x in range(temp_start_point_x, start_point_x):
                ...
                temp_start_point_x = start_point_x
            temp_start_point_x = 0
            temp_start_point_y = start_point_y
        ...
        #  print(division_start_point_x_list, division_start_point_y_list)
        #  print(cls.divide_list)
        # print(cls.divide_value_list)
        # print(cls.divide_total_value_list)
        # print(len(cls.divide_list), len(cls.divide_value_list))
        # print(cls.divide_total_value_list)
        #  print(cls.random_target_field)
